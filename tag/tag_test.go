...
func TestGetNextVersion(t *testing.T) {
	...
	var tests = []getNextVersionTest{
		...
		{"php:7.2.0-fpm", false, nil,"php:7.2.34-fpm"},
		...
		{"golang:1.12.0", false, nil, "golang:1.12.17"},
		{"golang:1.12.99", false, nil, "golang:1.13.15"},
		{"golang:1.12.99", false, &minor, "golang:1.12.99"},
		{"index.docker.io/library/golang:1.12.6", false, nil, "index.docker.io/library/golang:1.12.17"},
